...
public class Etudiant implements Serializable {
	...
	@ManyToOne
	@JoinColumns({
		@JoinColumn(name="ANNEE_UNIVERSITAIRE", referencedColumnName="ANNEE_UNIVERSITAIRE",updatable = false, insertable = false),
		@JoinColumn(name="CODE_FORMATION", referencedColumnName="CODE_FORMATION",updatable = false, insertable = false)
		})
