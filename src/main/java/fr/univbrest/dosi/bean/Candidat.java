...
public class Candidat implements Serializable {
  ...
  //uni-directional many-to-one association to Promotion
  	@ManyToOne
  	@JoinColumns({
  		@JoinColumn(name="ANNEE_UNIVERSITAIRE", referencedColumnName="ANNEE_UNIVERSITAIRE",updatable = false, insertable = true),
  		@JoinColumn(name="CODE_FORMATION", referencedColumnName="CODE_FORMATION",updatable = false, insertable = true)
  		})
