...
public class Formation implements Serializable {
	...
	public Formation(String codefrm,Date da,String diplome,String double_dip,Date FA,BigDecimal A,String nomF) {
		this.codeFormation=codefrm;
		this.debutAccreditation=da;
		this.doubleDiplome=double_dip;
		this.diplome=diplome;
		this.finAccreditation=FA;
		this.n0Annee=A;
