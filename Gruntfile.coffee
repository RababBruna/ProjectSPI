...
module.exports = (grunt) ->
    ...
    grunt.initConfig
        ...
        less:
            server:
                ...
                files: [
                    ...
                    src: "main.less"
                    dest: "src/main/resources/.tmp/styles"
                    ext: ".css"                    
                ]
            dev:
                options:
                ...
                files: [
                    ...
                    cwd: "<%= yeoman.app %>/styles-less"
                    src: "main.less"
                    dest: "src/main/resources/client/styles"
                    ext: ".css"                    
                ]
            dist:
                options:
        ...
        copy:
            dist:
                ...
                ,
                    expand: true
                    cwd: "src/main/resources/.tmp/images"
    ...
    grunt.registerTask "lessServer", (target) ->
        ...
        grunt.task.run ["clean:server", "concurrent:lessServer", "watch"]
